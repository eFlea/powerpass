...
function New-SecurePassword {
    ...
    Write-Verbose "Wolfram is pretty good at doing this kinda math. https://www.wolframalpha.com/input?i=7776%5E$numWords"
    ...
    Write-Verbose "Here's some data on cracking speeds - https://github.com/search?q=hashcat+benchmark&type=repositories"
    Write-Verbose ""

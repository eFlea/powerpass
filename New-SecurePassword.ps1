...
function New-SecurePassword {
    ...
    Write-Verbose "Wolfram is pretty good at doing this kinda math. https://www.wolframalpha.com/input?i=%287776%5E$numWords+hashes%2F2%29+%2F+1+megahashes%2Fsecond+in+years"
    ...
    Write-Verbose "Here's some data on cracking speeds - https://www.hivesystems.com/blog/are-your-passwords-in-the-green?utm_source=header (Where I got the 1 Megahashes/second # from)"

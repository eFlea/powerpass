...
.EXAMPLE
PS> .\Get-SecurePassword.ps1 -EFFWordlistPath "c:\users\username\Downloads\eff_large_wordlist.txt" -NumWords 8 -Verbose
...
function Show-Help {
    ...
    Write-Host ""
    Write-Host "Example:"
    Write-Host "`tPS> .\Get-SecurePassword.ps1 -EFFWordlistPath "c:\users\username\Downloads\eff_large_wordlist.txt" -NumWords 8 -Exclude '$!@' -Verbose"
    Write-Host ""
